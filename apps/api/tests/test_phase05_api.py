...
def test_controlled_change_creates_a_new_version_without_rewriting_source(client):
    ...
    round_id = client.post("/api/v1/rounds", json={"semester_id": semester_id, "type": "REVIEW_3", "reviewer_count": 3, "room_types": ["NORMAL"], "session_duration_minutes": 30}, headers=headers).json()["id"]
