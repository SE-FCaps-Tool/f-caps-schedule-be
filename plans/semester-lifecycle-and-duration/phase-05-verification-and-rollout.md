...
4. Run `docker compose up` with the existing volume; verify the API/worker bootstrap does not truncate data.
...
- API/worker bootstrap completes successfully and reports expected populated-database behavior.
